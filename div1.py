...
if creator.__contains__("l:"):
    ...
    if creator == "l:TSL_s1":
        ...
        # NCAAM - division 1
        if creator == "l:ncaa_d1":
            # ADDING TEAMS

            # America East
            albany = Team("University at Albany")
            binghampton = Team("Binghampton University")
            hartford = Team("University of Hartford")
            umaine = Team("University of Maine")
            umbc = Team("University of Maryland-Baltimore County")
            umass_lowell = Team("University of Massachusetts-Lowell")
            new_hampshire = Team("University of New Hampshire")
            njit = Team("New Jersey Institute of Technology")
            stony_brook = Team("Stony Brook")
            vermont = Team("University of Vermont")

            # AAC
            ucf = Team("University of Central Florida")
            cincinatti = Team("University of Cincinatti")
            ecu = Team("East Carolina University")
            houston = Team("University of Houston")
            memphis = Team("University of Memphis")
            usf = Team("University of South Florida")
            smu = Team("Southern Methodist University")
            temple = Team("University of Temple")
            tulane = Team("Tulane University")
            tulsa = Team("Tulsa University")
            wichita_state = Team("Wichita State University")

            # ACC
            boston_college = Team("Boston College University")
            clemson = Team("Clemson University")
            duke = Team("Duke University")
            florida_state = Team("Florida State University")
            georgia_tech = Team("Georgia Tech")
            louisville = Team("University of Louisville")
            miami_fl = Team("University of Miami @ Florida")
            unc = Team("University of North Carolina")
            nc_state = Team("North Carolina State University")
            notre_dame = Team("Notre Dame University")
            pitt = Team("University of Pittsburgh")
            syracuse = Team("Syracuse University")
            virginia = Team("University of Virginia")
            virginia_tech = Team("Virginia Tech")
            wake_forest = Team("Wake Forest")

            # ASUN
            bellarmine = Team("Bellarmine University")
            fgcu = Team("Florida Gulf Coast University")
            jacksonville = Team("Jacksonville University")
            kennesaw = Team("Kennesaw State University")
            liberty = Team("Liberty University")
            libscomb = Team("Lipscomb University")
            north_alabama = Team("University of North Alabama")
            stetson = Team("Stetson University")

            # A10
            davidson = Team("Davidson College")
            dayton = Team("University of Dayton")
            duqunesque = Team("Duqunesque University")
            fordham = Team("Fordham University")
            george_mason = Team("George Mason University")
            george_washington = Team("George Washington University")
            la_salle = Team("La Salle University")
            umass = Team("University of Massachusetts Amherst")
            rhode_island = Team("Rhode Island University")
            richmond = Team("University of Richmond")
            st_bonaventure = Team("St. Bonaventure University")
            st_josephs = Team("St. Joseph's University")
            st_louis = Team("Saint Louis University")
            vcu = Team("Virginia Commonwealth University")

            # Big East
            butler = Team("Butler University")
            creighton = Team("Creighton University")
            depaul = Team("DePaul University")
            georgetown = Team("Georgetown University")
            marquette = Team("Marquette University")
            providence = Team("Providence College")
            st_johns = Team("St. John's University")
            seton_hall = Team("Seton Hall University")
            uconn = Team("University of Connecticut")
            villanova = Team("Villanova University")
            xavier = Team("Xavier University")

            # Big Sky
            eastern_washington = Team("Eastern Washington University")
            idaho = Team("University of Idaho")
            idaho_state = Team("Idaho State University")
            montana = Team("University of Montana")
            montana_state = Team("Montana State University")
            northern_arizona = Team("Northern Arizona University")
            northern_colorado = Team("University of Northern Colorado")
            portland_state = Team("Portland State University")
            california_state = Team("California State University")
            southern_utah = Team("Southern Utah University")
            weber_state = Team("Weber State University")

            # Big South
            campbell = Team("Campbell University")
            charleston_southern = Team("Charleston Southern University")
            gardner_webb = Team("Gardner-Webb University")
            hampton = Team("Hampton University")
            high_point = Team("High Point University")
            longwood = Team("Longwood University")
            presbyterian = Team("Presbyterian College")
            radford = Team("Radford University")
            unc_asheville = Team("University of North Carolina - Asheville")
            usc_upstate = Team("University of South Carolina Upstate")
            winthrop = Team("Winthrop University")

            # Big Ten
            illinois = Team("University of Illinois")
            indiana = Team("Indiana University")
            iowa = Team("University of Iowa")
            maryland = Team("University of Maryland")
            michigan = Team("University of Michigan")
            michigan_state = Team("Michigan State University")
            minnesota = Team("University of Minnesota")
            nebraska = Team("University of Nebraska")
            northwestern = Team("Northwestern University")
            ohio_state = Team("Ohio State University")
            penn_state = Team("Pennsylvania State University")
            purdue = Team("Purdue University")
            rutgers = Team("Rutgers University")
            wisconsin = Team("University of Wisconsin")

            # Big 12
            baylor = Team("Baylor University")
            iowa_state = Team("Iowa State University")
            kansas = Team("University of Kansas")
            kansas_state = Team("Kansas State University")
            oklahoma = Team("University of Oklahoma")
            oklahoma_state = Team("Oklahoma State University")
            texas = Team("University of Texas")
            tcu = Team("TCU")
            texas_tech = Team("Texas Tech University")
            west_virginia = Team("West Virginia University")

            # Big West
            cal_poly = Team("California Polytechnic State University")
            csu_bakersfield = Team("California State University - Bakersfield")
            cal_state_fullerton = Team("California State Fullerton")
            cal_state_northridge = Team("California State Northridge")
            hawaii = Team("Hawaii")
            long_beach_state = Team("California State University Long Beach")
            uc_davis = Team("UC Davis")
            uc_irvine = Team("UC Irvine")
            uc_riverside = Team("UC Riverside")
            uc_san_diego = Team("UC San Diego")
            uc_santa_barbara = Team("UC Santa Barbara")

            # CAA
            charleston = Team("College of Charleston")
            delaware = Team("University of Delaware")
            drexel = Team("Drexel University")
            elon = Team("Elon University")
            hofstra = Team("Hofstra University")
            james_madison = Team("James Madison University")
            northeastern = Team("Northeastern University")
            towson = Team("Towson University")
            uncw = Team("UNC Wilmington")
            william_mary = Team("College of William & Mary")

            # C-USA
            charlotte = Team("UNC Charlotte")
            fau = Team("Florida Atlantic University")
            fiu = Team("Florida International University")
            la_tech = Team("Louisiana Tech University")
            marshall = Team("Marshall University")
            middle_tenn = Team("Middle Tennessee State University")
            north_texas = Team("University of North Texas")
            old_dominion = Team("Old Dominion University")
            rice = Team("Rice University")
            southern_miss = Team("University of Southern Mississippi")
            uab = Team("University of Alabama Birmingham")
            utep = Team("University of Texas at El Paso")
            utsa = Team("University of Texas at San Antonio")
            wku = Team("Western Kentucky University")
